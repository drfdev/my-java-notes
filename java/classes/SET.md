...
* of()
  Пустой немодифицированный список (константа из `ImmutableCollections.EMPTY_SET`)
* of(...)
  Немодифицируемый список, выбирается отптимизированный для определенного количества класс из ImmutableCollections
* copyOf(Collection<E>)
